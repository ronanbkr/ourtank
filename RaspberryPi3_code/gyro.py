...
#           Gz = Gz + 360
    ...
    def trackAngle(self):
        ...
        #threading.Thread(self.trackAngleThread, ())
    ...
    def trackYaw(self):
        ...
        #threading.Thread(self.trackYawThread,())
...
def getGyroData():
    ...
    while True:
        ...
        #yaw = [] 
        yaw = IMU.prevYaw#IMU.updateYaw() 
        #angle = []
        angle = IMU.prevAngle 
        accle = IMU.readAccelerometer()  
        gyros = IMU.readGyro()
        magne = IMU.readMagnetometer()
        
        #magAngle = round(math.atan2(magne[0], magne[1]), 2)
        magAngle = magne[0]**2 + magne[1]**2 + magne[2]**2
        allData = ["Yaw", yaw, "Angle", angle, "Accelerometer", accle, "Gyros", gyros, "Magnetometer", magne, "MagAngle", magAngle]
           
        #print(IMU.prevYaw)
        #print(IMU.prevAngle[0][0], IMU.prevAngle[0][1], IMU.prevAngle[0][2])     # Roll
        #print(IMU.prevAngle[0][0])
        #print(IMU.prevAngle[0][1])      # Pitch
        #print(IMU.prevAngle[0][2])     # Yaw
        #print()
        #print("Acclerometer: ", IMU.readAccelerometer())
        #print()
        #print("Gyro: ", IMU.readGyro()) 
        #print()
        #print("Magnetometer ", IMU.readMagnetometer())
        #print(magne)
        #angle = math.atan2(magne[0], magne[1])
